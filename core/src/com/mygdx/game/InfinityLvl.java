...
public class InfinityLvl implements Screen {
    ...
    public InfinityLvl(final Drop gam) {
        this.game = gam;
        count = 0;
        ...
        stars = new String[]{"do", "re", "mi","fa","la","sol", "si",};
        int i = MathUtils.random(0,6);
    ...
    public void render(float delta) {
        ...
        if(TimeUtils.nanoTime() - lastDropTime > 800000000 && !(success)) spawnRaindrop(stars[MathUtils.random(0,6)]);
